...
import com.example.ilmubahasainggris.VideoMateri.VideoMateri5Activity;
...
public class Materi5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!= null){
            getSupportActionBar().setTitle("Judul 5");
        }
        ...
        btnvideo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Materi5Activity.this, VideoMateri5Activity.class);
